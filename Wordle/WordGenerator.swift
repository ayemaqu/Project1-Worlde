...
class WordGenerator {
  ...
  static let possibleWords = ["QUACK", "ANIME", "APPLE", "PHONE", "MANGO", "CRUST", "FAITH", "CLOWN", "TOWEL", "SHARP", "SPACE", "OFTEN", "LUNCH", "EARTH"]
  static func generateRandomWord() -> String? {
    // START YOUR CODE HERE 
      return possibleWords.randomElement() //    return possibleWords.first
    // END YOUR CODE HERE
  }
}
